...
VLAN i seg selv gjør ikke nettet sikrere – det er brannmurregelene mellom dem som gjør jobben. Brukte en stund på å skjønne at nye pfSense-interfacer har default deny på all trafikk, mens LAN har default allow.
